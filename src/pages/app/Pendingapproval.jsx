...
const Pendingapproval = () => {
  ...
  return (
    <>
      ...
      <div
        // onClick={() => navigate("/app/inspection")}
        onClick={() => navigate("/app/dashboard")}
        className="flex justify-center items-center min-h-screen bg-[#F3F8FF]"
      >
        <div className="text-center w-full">
          ...
          <>
            ...
            <p className="text-gray-600 text-sm">
              Your request to rent this property has been sent to the landlord
              for approval. The deposit amount will
              <br />
          ...
          {/* {screenIndex === 1 && (
            <>
              ...
              <p className="text-gray-600 text-sm">
                Your request to link [Property Name] was rejected by the
                landlord. The deposit of $2500 remains
                <br />
          ...
          {screenIndex === 2 && (
            <>
              ...
              <p className="text-gray-600 text-sm">
                Your deposit for [Property Name] has been approved by the
                landlord. Funds are now securely held in escrow.
              </p>
            </>
          )} */}
        </div>
