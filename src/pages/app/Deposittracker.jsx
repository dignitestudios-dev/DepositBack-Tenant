  ...
  return (
    <div className="max-w-[1260px] mx-auto px-6 pt-8 pb-20 min-h-screen bg-[#F6FAFF] text-[#333]">
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
            <div className="bg-white rounded-xl shadow-xl p-6 w-[90%] max-w-sm text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Are you sure you want to release the refundable deposit of $2300
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        {data?.depositTracker?.deductions.length > 0 ? (
          <div> </div>
        ) : (
          <div>No Receipts or Deductions Yet</div>
        )}
        {/* {!uploaded && (
        ...
        {/* {uploaded && (
          <div className="bg-[#F3F3F3] p-6 rounded-2xl items-start">
            ...
            <span className="text-[14px] font-[500] pt-1">
              Date: Sun,15,2024
            </span>
            <br />
            <span className="text-[14px] font-[500] pt-1">
              Deduction: <span className="text-red-600">$200</span>
            </span>
