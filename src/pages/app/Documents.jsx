...
const Documents = () => {
  ...
  const [viewMode, setViewMode] = useState("Agreements");
  const navigate = useNavigate("");
  const location = useLocation();

  const landlordTabs = ["Agreements", "Repairs"];
  ...
  const currentTabs = viewMode === "Agreements" && landlordTabs;
      ...
      <div className="max-w-[1260px] mx-auto pt-8 pb-[10em]">
        ...
        <div className="flex justify-between">
          <div className="flex gap-3 items-center mb-6 pt-3">
            <button
              type="button"
              onClick={() => navigate("/app/property-detail")}
            >
              <FaArrowLeft size={20} />
            </button>
