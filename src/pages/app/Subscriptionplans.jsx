...
import { AppContext } from "../../context/AppContext";  // Assuming the context is imported from here
import axios from "../../axios";
import { ErrorToast, SuccessToast } from "../../components/global/Toaster";

export default function Subscriptionplans() {
    const navigate = useNavigate();
    const { userData, token, logoutContext } = useContext(AppContext);  // Get user data and token from context
    ...
    const cancelSubscription = async () => {
        if (userData?.subscriptionProduct) {
            try {
                ...
                ErrorToast("There was an error cancelling your subscription. Please try again.");
            }
        }
    };
                ...
                <div className="max-w-[1260px] mx-auto px-6 pt-8 pb-20">
                    <div className="w-full max-w-7xl">
                        ...
                        <p className="text-left ml-[4em] text-gray-500 max-w-4xl mb-12 text-[15px] leading-relaxed">
                            Your subscription will begin immediately after purchase at the price mentioned above and will automatically renew at the same price until you cancel. To avoid renewal, cancel at least 24 hours before the end of your billing cycle. Once subscribed, you can manage and cancel your subscription anytime.
                        </p>
