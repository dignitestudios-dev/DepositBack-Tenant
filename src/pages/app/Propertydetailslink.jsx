        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 bg-white p-6 rounded-2xl">
          ...
          <div className="bg-white p-6 w-[44em]">
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                eget dictum libero. Vivamus ac aliquam dui. Curabitur ut libero
                non justo pellentesque sollicitudin. Nulla mauris est, venenatis
                et volutpat sit amet, efficitur sit amet lectus. Lorem ipsum
                dolor sit amet, consectetur adipiscing elit. Vestibulum eget
                dictum libero. Vivamus ac aliquam dui. Curabitur ut libero non
                justo pellentesque sollicitudin. Nulla mauris est, venenatis et
                volutpat sit amet.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F3F8FF] w-[30em] rounded-2xl p-6">
            <div className=" pt-0 text-sm">
              <div className="flex justify-between items-center pb-1 pl-3 pr-3">
                {" "}
                <h5 className="font-[500] text-black mb-2 text-[16px]">
                  Reviews by Tenant
                </h5>
                <span>View all</span>
              </div>
              ...
              {[1, 2, 3].map((_, index) => (
                <div
                  key={index}
                  className="border-b pb-4 mb-4 pl-6 pt-3 bg-white rounded-2xl "
                >
                  ...
                  <p className="text-sm text-gray-700 mb-2">
                    Amazing product. I booked on Monday and I got my order on
                    the next day. I'm highly impressed with their services.
                    Highly recommended!
                  </p>
                </div>
              ))}
