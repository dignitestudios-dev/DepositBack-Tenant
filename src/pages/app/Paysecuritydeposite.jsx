    ...
    <div className="min-h-screen bg-[#F3F8FF] p-10 rounded-2xl ">
      <div className="text-left mb-8 max-w-[1260px] mx-auto pt-0">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          This property requires a deposit of ${depositAmount}. The deposit will
          not be deducted until the landlord approves your request to rent this
          property. The deposit will be securely held in escrow and refunded at
          the end of your agreement, less any deductions for damages or unpaid
          rent.
        </p>
      </div>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-[30em]">
            ...
            <p className="text-[14px] pb-4">
              Enter your payment details to securely process the deposit for
              this property. Stripe ensures your data is encrypted and safe.
            </p>
            <label className="block text-sm font-[500] text-black pb-1">
              Card Holder Name
            </label>
            <input
              type="text"
