...
export default function SubscriptionPlans() {
  ...
  const basicPlanData = {
    ...
    type: "Monthly Plan",
    price: "19.87",
    sku: "deposit_back_tenant_monthly",
    features: [
      "7 days free trial",
    ...
    <div className="min-h-screen bg-[#f3f6fb] flex flex-col items-center p-6 pt-20 pb-20">
      <div className="w-full max-w-6xl">
        ...
        <p className="text-center text-gray-500 max-w-4xl mx-auto mb-12 text-[15px] leading-relaxed">
          Your subscription will begin immediately after pruchase at the price
          mentioned above and will automatically renew at the same price until
          you cancel.To avoid renewal,cancel at least 24 hours before the end of
          your billing cycle. Once susbcribed, you can manage and cancel your
